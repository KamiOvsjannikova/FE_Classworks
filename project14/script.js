...
//Zadacha v header dobavitj h1 s tekstom my Title
/*const header = document.querySelector("header")
...
//for(let i = 0; i < 10; i++){
   /// section.innerHTML += "<p> Hello Kami </p>"
//}
...
section.innerHTML += `<h1>summa productov sost. ${sum}</h1>`



//section.innerHTML += `<p> ${names[0]} </p>`
// section.innerHTML += `<p> ${names[1]} </p>`
///section.innerHTML = <div calss="product">
/* section.innerHTML += ` <div class="product">
